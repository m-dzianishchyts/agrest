...
CREATE TABLE "e34" ("id" INTEGER  NOT NULL GENERATED BY DEFAULT AS IDENTITY, "name" VARCHAR (255), PRIMARY KEY ("id"))
;

CREATE TABLE "e35" ("id" INTEGER  NOT NULL GENERATED BY DEFAULT AS IDENTITY, "e34_id" INTEGER  NOT NULL, "season" VARCHAR (16), "ranking" INTEGER , PRIMARY KEY ("id"))
;

ALTER TABLE "e35" ADD FOREIGN KEY ("e34_id") REFERENCES "e34" ("id")
;

CREATE SEQUENCE "PK_e34" AS BIGINT START WITH 200 INCREMENT BY 20 NO MAXVALUE NO CYCLE
;

CREATE SEQUENCE "PK_e35" AS BIGINT START WITH 200 INCREMENT BY 20 NO MAXVALUE NO CYCLE
;
